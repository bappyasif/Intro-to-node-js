...
// routes are defined either using .get() or .post() methods on the router object
...
// handler functions are all imported from the controller modules that we created
